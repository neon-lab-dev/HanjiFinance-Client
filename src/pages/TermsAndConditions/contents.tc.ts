export const contents = [
  ...
  },
  {
    ...
    description:
      "All original content on this site (videos, PDFs, reports, templates) is the property of Hanjifinance. You may not reuse, republish, or resell any content without written consent.",
  },
  {
    title: "Limitation of Liability",
    description:
      "Financial markets involve risk. While advisory is provided with diligence and compliance, we do not guarantee returns or investment performance. You agree to use the information at your own discretion. Past performance is not indicative of future results.",
  },
  {
    title: "Regulatory Disclosures",
    description:
      "Hanjifinance is in full compliance with SEBI Investment Adviser regulations. For unresolved grievances, clients may escalate through the SEBI SCORES platform.",
  },
  {
    title: "Governing Law",
    description:
      "These Terms are governed by the laws of India. Any disputes shall be subject to the jurisdiction of courts in Gwalior , India.",
  },
  {
    title: "Contact",
    description:
      "<p>For any clarification or grievance, <br/> Contact: <a href='mailto:hanjifinanceteam@gmail.com' class='text-blue-500 underline'>hanjifinanceteam@gmail.com</a></p>",
  },
  {
    title: "Payments & Pricing",
    description:
