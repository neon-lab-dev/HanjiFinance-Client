...
const AvailableSlotsCard = ({ date }: SlotCardProps) => {
  return (
    <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-start md:items-center bg-surface-30 p-4 border-[1px] rounded-lg border-neutral-98 font-Montserrat">
      <div className="flex items-center justify-start gap-4">
        <span className="font-medium leading-[22px] text-neutral-20">
          {date}
        </span>
        <p className="text-neutral-85 text-[13px] leading-4 ">
          <p className="text-neutral-85 text-[13px] leading-4 ">
            7:00 PM - 7:30 PM
          </p>
        </p>
