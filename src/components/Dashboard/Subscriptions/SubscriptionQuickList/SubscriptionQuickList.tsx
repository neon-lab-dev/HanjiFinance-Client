  ...
  const quickActions = [
    {
      ...
      description:
        "A request will be raised to the team to hold your whatsapp group access until a selected date",
    ...
    },
    {
      ...
      description:
        "A request will be raised to the team to terminate  your whatsapp group permanently",
